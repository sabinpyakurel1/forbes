	...
	<div class="span2">
          <div class="well sidebar-nav">
			...
			<li class="active"><a href="addstudent.php"><i class="icon-user icon-2x"></i>Add Student</a>     </li>
				...
				<li><a href="1batche.php"><i class="icon-user icon-2x"></i>First Batche</a>         </li>
    <li><a href="2batche.php"><i class="icon-user icon-2x"></i>Second Batche</a>         </li>
    <li><a href="3batche.php"><i class="icon-user icon-2x"></i>Third Batche</a>         </li>
...
<span>Student ID: </span><input type="text" style="width:265px; height:30px;"  <?php 
...
<br>
<span>Job Position and Company Name : </span><textarea style="width:265px; height:50px;" name="report" ></textarea><br>

<span>Photo:</span><input type="file" name="file" id="file" required ><br><br>
<div >
	<span>Password:</span><input type="password" name="password" id="pasword" required ><br><br>
<div >
