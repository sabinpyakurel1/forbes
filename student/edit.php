...
<center><?php
  include('../connect.php');
  $name=$_GET['name'];
  $result = $db->prepare("SELECT * FROM student WHERE name= :name");
  $result->bindParam(':name', $name);
  $result->execute();
  for($i=0; $row = $result->fetch(); $i++){
?>
<link href="../style.css" media="screen" rel="stylesheet" type="text/css" />
<form action="savedetail.php" method="post" enctype="multipart/form-data">
...
<span>Job Position and Company Name : </span><textarea style="width:265px; height:50px;" name="report" ><?php echo $row['report']; ?> </textarea><br><br>
